...
public class OutInvoiceFragment extends Fragment implements ModelChangeListener {
    public String TAG = "OutInvoiceFragment";
    ...
    private void updateInvoicesFromDatabase() {
        this.invoices = LoadDatabase.getInstance().getUnPaidInvoices(1);
    }
    ...
    private void initLayout() {
        ...
        this.invoice_message.setText(this.mActivity.getResources().getString(R.string.unpaid_invoice_message));
    }
